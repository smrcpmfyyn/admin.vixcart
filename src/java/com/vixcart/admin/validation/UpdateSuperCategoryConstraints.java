...
import com.vixcart.admin.intfc.validation.UpdateSuperCategoryValidator;
 ...
 * @author Vineeth K
 */
public class UpdateSuperCategoryConstraints implements UpdateSuperCategoryValidator {

    private final UpdateSuperCategory req;
    private final MongoConnect mdbc;
    private final DBConnect dbc;

    public UpdateSuperCategoryConstraints(UpdateSuperCategory req) throws Exception {
        this.req = req;
...
//        System.out.println("types = " + types);
    ...
    public String validateSuperCategory() throws Exception {
        ...
        String param = req.getSuper_category();
        if (validate(param, regX)) {
            if (dbc.checkSuperCategoryById(param) == 1) {
