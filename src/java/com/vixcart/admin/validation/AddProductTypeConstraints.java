...
import com.vixcart.admin.intfc.validation.AddProductTypeValidator;
 ...
 * @author Vineeth K
 */
public class AddProductTypeConstraints implements AddProductTypeValidator {

    private final AddProductType req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public AddProductTypeConstraints(AddProductType req) throws Exception {
        this.req = req;
