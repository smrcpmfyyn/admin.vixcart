...
import com.vixcart.admin.processreq.ProcessGetSuperCategory;
 ...
 * @author Vineeth K
 */
public class getSuperCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String supCategId = request.getParameter("supCategId");
