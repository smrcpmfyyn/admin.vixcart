...
import com.vixcart.admin.intfc.validation.GetAffiliateValidator;
 ...
 * @author rifaie
 */
public class GetAffiliateConstraints implements GetAffiliateValidator {
    private final GetAffiliate req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetAffiliateConstraints(GetAffiliate req) throws Exception {
        this.req = req;
