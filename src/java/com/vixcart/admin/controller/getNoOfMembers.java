...
import com.vixcart.admin.processreq.ProcessGetNoOfMembers;
import com.vixcart.admin.req.mod.GetNoOfMembers;
import com.vixcart.admin.resp.mod.GetNoOfMembersFailiureResponse;
...
import com.vixcart.admin.validation.GetNoOfMembersValidation;
 ...
 * @author rifaie
 */
public class getNoOfMembers extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            GetNoOfMembers req = new GetNoOfMembers(at);
            GetNoOfMembersValidation reqV = new GetNoOfMembersValidation(req);
            reqV.validation();
            GetNoOfMembersResult reqR = JSONParser.parseJSONGNOM(reqV.toString());
            ...
            if (validSubmission.equals(CorrectMsg.CORRECT_MESSAGE)) {
                ...
                GetNoOfMembersFailiureResponse FResp = new GetNoOfMembersFailiureResponse(reqR, validSubmission);
                out.println(FResp);
            } else {
                //exception Response
            }
