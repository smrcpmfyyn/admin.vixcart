 ...
 * @author Vineeth K
 */
public class GetProductTypesFailureResponse {
private final GetProductTypesResult req;
    private final String error;

    public GetProductTypesFailureResponse(GetProductTypesResult req, String error) {
        this.req = req;
        this.error = error;
    }
