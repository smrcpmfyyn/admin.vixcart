...
import com.vixcart.admin.processreq.ProcessFAUA;
import com.vixcart.admin.req.mod.FAUA;
import com.vixcart.admin.resp.mod.FAUAFailureResponse;
...
import com.vixcart.admin.validation.FAUAValidation;
 ...
 * @author rifaie
 */
public class filterAdminUserActivities extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            UserActivities ua = new UserActivities(req.getAdmin_id(), req.getUtype(), "filter_admin_user_activities", "management", "valid");
