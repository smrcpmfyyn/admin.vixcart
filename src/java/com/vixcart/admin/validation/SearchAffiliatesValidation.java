 ...
 * @author rifaie
 */
public class SearchAffiliatesValidation implements Validation{
    private final SearchAffiliates req;
    private String paramValue = "";
    private String paramName = "";

    public SearchAffiliatesValidation(SearchAffiliates req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        SearchAffiliatesConstraints reqC = new SearchAffiliatesConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_SEARCH_AFFILIATES;
        } else {
            paramValue += ErrMsg.ERR_SEARCH_AFFILIATES;
        }
    }
