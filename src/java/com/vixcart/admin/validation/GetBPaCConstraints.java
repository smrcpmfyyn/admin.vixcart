...
import com.vixcart.admin.intfc.validation.GetBPaCValidator;
 ...
 * @author Vineeth K
 */
public class GetBPaCConstraints implements GetBPaCValidator {

    private final GetBPaC req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetBPaCConstraints(GetBPaC req) throws Exception {
        this.req = req;
