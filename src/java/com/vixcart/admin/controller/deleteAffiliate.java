...
import com.vixcart.admin.processreq.ProcessDeleteAffiliate;
import com.vixcart.admin.req.mod.DeleteAffiliate;
import com.vixcart.admin.resp.mod.DeleteAffiliateFailureResponse;
...
import com.vixcart.admin.validation.DeleteAffiliateValidation;
 ...
 * @author rifaie
 */
public class deleteAffiliate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DeleteAffiliate req = new DeleteAffiliate(at, aff);
            DeleteAffiliateValidation reqV = new DeleteAffiliateValidation(req);
            reqV.validation();
            DeleteAffiliateResult reqR = JSONParser.parseJSONDA(reqV.toString());
            String validSubmission = reqR.getValidationResult();
            UserActivities ua = new UserActivities(req.getAdmin_id(), req.getType(), "delete_affiliate", "affiliate", "valid");
            if (validSubmission.equals(CorrectMsg.CORRECT_MESSAGE)) {
                ...
                DeleteAffiliateFailureResponse FResp = new DeleteAffiliateFailureResponse(reqR, validSubmission);
                out.println(FResp);
            } else {
                //exception Response
            }
