 ...
 * @author Vineeth K
 */
public class UpdateProductTypeValidation implements Validation{
    private final UpdateProductType req;
    private String paramValue = "";
    private String paramName = "";

    public UpdateProductTypeValidation(UpdateProductType req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        UpdateProductTypeConstraints reqC = new UpdateProductTypeConstraints(req);
        String valid = "";
