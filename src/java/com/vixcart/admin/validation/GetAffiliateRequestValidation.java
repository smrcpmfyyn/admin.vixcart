 ...
 * @author rifaie
 */
public class GetAffiliateRequestValidation implements Validation{
    
    private final GetAffiliateRequest req;
    private String paramValue = "";
    private String paramName = "";

    public GetAffiliateRequestValidation(GetAffiliateRequest req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        GetAffiliateRequestConstraints reqC = new GetAffiliateRequestConstraints(req);
        String valid = "";
