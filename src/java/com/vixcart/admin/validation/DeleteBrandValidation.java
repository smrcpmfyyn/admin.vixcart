 ...
 * @author Vineeth K
 */
public class DeleteBrandValidation implements Validation{
    private final DeleteBrand req;
    private String paramValue = "";
    private String paramName = "";

    public DeleteBrandValidation(DeleteBrand req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        DeleteBrandConstraints reqC = new DeleteBrandConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_DELETE_BRAND;
        } else {
            paramValue += ErrMsg.ERR_DELETE_BRAND;
        }
    }
