 ...
 * @author rifaie
 */
public class UserTypesResult implements Result{
    private String at;
    private String admintype;
    private String typesValidation;
    ...
    public void setTypesValidation(String typesValidation) {
    ...
    public boolean isRequestValid() {
        boolean flag = false;
        if (typesValidation.startsWith(CorrectMsg.CORRECT_MESSAGE)) {
            flag = true;
        }
        return flag;
    }
