 ...
 * @author Vineeth K
 */
public class AddProductTypeFailureResponse {
private final AddProductTypeResult req;
    private final String error;

    public AddProductTypeFailureResponse(AddProductTypeResult req, String error) {
        this.req = req;
        this.error = error;
    }
