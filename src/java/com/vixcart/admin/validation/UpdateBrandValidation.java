 ...
 * @author Vineeth K
 */
public class UpdateBrandValidation implements Validation{
    private final UpdateBrand req;
    private String paramValue = "";
    private String paramName = "";

    public UpdateBrandValidation(UpdateBrand req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        UpdateBrandConstraints reqC = new UpdateBrandConstraints(req);
        String valid = "";
