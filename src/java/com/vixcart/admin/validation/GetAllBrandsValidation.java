 ...
 * @author Vineeth K
 */
public class GetAllBrandsValidation implements Validation{
    private final GetAllBrands req;
    private String paramValue = "";
    private String paramName = "";

    public GetAllBrandsValidation(GetAllBrands req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        GetAllBrandsConstraints reqC = new GetAllBrandsConstraints(req);
        String valid = "";
