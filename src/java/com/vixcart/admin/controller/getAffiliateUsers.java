...
import com.vixcart.admin.processreq.ProcessGetAffiliateUsers;
import com.vixcart.admin.req.mod.GetAffiliateUsers;
import com.vixcart.admin.resp.mod.GetAffiliateUsersFailureResponse;
...
import com.vixcart.admin.validation.GetAffiliateUsersValidation;
...
public class getAffiliateUsers extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            GetAffiliateUsers req = new GetAffiliateUsers(at, query, maxEntries, pageNo);
            GetAffiliateUsersValidation reqV = new GetAffiliateUsersValidation(req);
            reqV.validation();
            GetAffiliateUsersResult reqR = JSONParser.parseJSONGAUR(reqV.toString());
            String validSubmission = reqR.getValidationResult();
            UserActivities ua = new UserActivities(req.getAdmin_id(), req.getUtype(), "get_affiliate_users", "management", "valid");
