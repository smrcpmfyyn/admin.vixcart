...
import com.vixcart.admin.intfc.validation.EmpReportValidator;
 ...
 * @author rifaie
 */
public class EmpReportConstraints implements EmpReportValidator {

    private final EmpReport empR;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public EmpReportConstraints(EmpReport empR) throws Exception {
        this.empR = empR;
    ...
    public String validateAccessToken() throws Exception {
        ...
        if (!admin.getProfile_id().startsWith(ErrMsg.ERR_MESSAGE)) {
            if (dbc.checkNBAdminID(admin.getProfile_id())) {
                ...
                empR.setAdmin_id(admin.getProfile_id());
                empR.setType(admin.getType());
            } else {
    ...
    public String validateUserType(String adminType) throws Exception {
        ...
        HashSet<String> types = dbc.getSubTypes(empR.getType());
