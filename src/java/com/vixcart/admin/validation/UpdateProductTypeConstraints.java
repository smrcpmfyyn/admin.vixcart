...
import com.vixcart.admin.intfc.validation.UpdateProductTypeValidator;
 ...
 * @author Vineeth K
 */
public class UpdateProductTypeConstraints implements UpdateProductTypeValidator {

    private final UpdateProductType req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public UpdateProductTypeConstraints(UpdateProductType req) throws Exception {
        this.req = req;
