...
import com.vixcart.admin.intfc.validation.GetBrandValidator;
 ...
 * @author Vineeth K
 */
public class GetBrandConstraints implements GetBrandValidator {

    private final GetBrand req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetBrandConstraints(GetBrand req) throws Exception {
        this.req = req;
