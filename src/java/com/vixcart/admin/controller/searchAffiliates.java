...
import com.vixcart.admin.processreq.ProcessSearchAffiliates;
import com.vixcart.admin.req.mod.SearchAffiliates;
import com.vixcart.admin.resp.mod.SearchAffiliatesFailiureResponse;
...
import com.vixcart.admin.validation.SearchAffiliatesValidation;
 ...
 * @author rifaie
 */
public class searchAffiliates extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            SearchAffiliates req = new SearchAffiliates(at,str);
            SearchAffiliatesValidation reqV = new SearchAffiliatesValidation(req);
            reqV.validation();
            SearchAffiliatesResult reqR = JSONParser.parseJSONSAR(reqV.toString());
            ...
            if (validSubmission.equals(CorrectMsg.CORRECT_MESSAGE)) {
                ...
                SearchAffiliatesFailiureResponse FResp = new SearchAffiliatesFailiureResponse(reqR, validSubmission);
                out.println(FResp);
            } else {
                //exception Response
            }
