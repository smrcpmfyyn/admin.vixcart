 ...
 * @author Vineeth K
 */
public class UpdateSpecificationValidation implements Validation{
    private final UpdateSpecification req;
    private String paramValue = "";
    private String paramName = "";

    public UpdateSpecificationValidation(UpdateSpecification req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        UpdateSpecificationConstraints reqC = new UpdateSpecificationConstraints(req);
        String valid = "";
