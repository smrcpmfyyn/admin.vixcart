...
import com.vixcart.admin.intfc.validation.DeleteBPaCValidator;
 ...
 * @author Vineeth K
 */
public class DeleteBPaCConstraints implements DeleteBPaCValidator {

    private final DeleteBPaC req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public DeleteBPaCConstraints(DeleteBPaC req) throws Exception {
        this.req = req;
