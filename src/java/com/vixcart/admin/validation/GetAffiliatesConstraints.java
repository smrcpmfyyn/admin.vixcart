...
import com.vixcart.admin.intfc.validation.GetAffiliatesValiadtor;
 ...
 * @author rifaie
 */
public class GetAffiliatesConstraints implements GetAffiliatesValiadtor {

    private final GetAffiliates req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetAffiliatesConstraints(GetAffiliates req) throws Exception {
        this.req = req;
