 ...
 * @author rifaie
 */
public class GetAllPremiumPaymentsFailiureResponse {
    private final GetAllPremiumPaymentsResult reqR;
    private final String error;

    public GetAllPremiumPaymentsFailiureResponse(GetAllPremiumPaymentsResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
