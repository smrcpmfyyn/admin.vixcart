...
import com.vixcart.admin.intfc.validation.GetMemberValidator;
 ...
 * @author rifaie
 */
public class GetMemberConstraints implements GetMemberValidator {
    private final GetMember req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetMemberConstraints(GetMember req) throws Exception {
        this.req = req;
