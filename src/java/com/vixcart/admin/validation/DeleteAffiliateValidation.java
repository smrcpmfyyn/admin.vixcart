 ...
 * @author rifaie
 */
public class DeleteAffiliateValidation implements Validation {
    
    private final DeleteAffiliate req;
    private String paramValue = "";
    private String paramName = "";

    public DeleteAffiliateValidation(DeleteAffiliate req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        DeleteAffiliateConstraints reqC = new DeleteAffiliateConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_DELETE_AFFILIATE;
        } else {
            paramValue += ErrMsg.ERR_DELETE_AFFILIATE;
        }
    }
