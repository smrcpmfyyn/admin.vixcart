...
import com.vixcart.admin.intfc.validation.LoadSpecificationsValidator;
 ...
 * @author Vineeth K
 */
public class LoadSpecificationsConstraints implements LoadSpecificationsValidator {

    private final LoadSpecifications req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public LoadSpecificationsConstraints(LoadSpecifications req) throws Exception {
        this.req = req;
