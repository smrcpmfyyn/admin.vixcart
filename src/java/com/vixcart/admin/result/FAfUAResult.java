 ...
 * @author rifaie
 */
public class FAfUAResult implements Result {
    private String at;
    private String admintype;
    private String ftruid;
    private String ftraff;
    ...
    public String getFtraff() {
        return ftraff;
    }

    public void setFtraff(String ftraff) {
        this.ftraff = ftraff;
    }
    ...
    public String getAllErrors() {
        ...
        if (at.startsWith(ErrMsg.ERR_MESSAGE)) {
            ...
            if(ftraff.startsWith(ErrMsg.ERR_MESSAGE)){
                error += "ftraff#";
            }
