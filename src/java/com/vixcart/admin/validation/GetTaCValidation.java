 ...
 * @author Vineeth K
 */
public class GetTaCValidation implements Validation{
    private final GetTaC req;
    private String paramValue = "";
    private String paramName = "";

    public GetTaCValidation(GetTaC req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        GetTaCConstraints reqC = new GetTaCConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_GET_TAC;
        } else {
            paramValue += ErrMsg.ERR_GET_TAC;
        }
    }
