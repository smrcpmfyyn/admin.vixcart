 ...
 * @author rifaie
 */
public class GetPinResult implements Result{
    
    private String at;
    private String admintype;
    private String gpValidation;
    ...
    public String getGpValidation() {
        return gpValidation;
    }

    public void setGpValidation(String gpValidation) {
        this.gpValidation = gpValidation;
    }
    ...
    public boolean isRequestValid() {
        boolean flag = false;
        if (gpValidation.startsWith(CorrectMsg.CORRECT_MESSAGE)) {
            flag = true;
        }
        return flag;
    }
