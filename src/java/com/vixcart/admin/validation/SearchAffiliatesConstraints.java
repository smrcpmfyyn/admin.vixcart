...
import com.vixcart.admin.intfc.validation.SearcgAffiliatesValiadtor;

/**
 * @company techvay
 * @author rifaie
 */
public class SearchAffiliatesConstraints implements SearcgAffiliatesValiadtor {

    private final SearchAffiliates req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public SearchAffiliatesConstraints(SearchAffiliates req) throws Exception {
        this.req = req;
