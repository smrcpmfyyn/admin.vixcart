 ...
 * @author Vineeth K
 */
public class GetProductTypeValidation implements Validation{
    private final GetProductType req;
    private String paramValue = "";
    private String paramName = "";

    public GetProductTypeValidation(GetProductType req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        GetProductTypeConstraints reqC = new GetProductTypeConstraints(req);
        String valid = "";
