...
import com.vixcart.admin.intfc.validation.UpdateBrandValidator;
 ...
 * @author Vineeth K
 */
public class UpdateBrandConstraints implements UpdateBrandValidator {

    private final UpdateBrand req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public UpdateBrandConstraints(UpdateBrand req) throws Exception {
        this.req = req;
