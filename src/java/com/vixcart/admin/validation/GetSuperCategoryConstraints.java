...
import com.vixcart.admin.intfc.validation.GetSuperCategoryValidator;
 ...
 * @author Vineeth K
 */
public class GetSuperCategoryConstraints implements GetSuperCategoryValidator {

    private final GetSuperCategory req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetSuperCategoryConstraints(GetSuperCategory req) throws Exception {
        this.req = req;
