 ...
 * @author rifaie
 */
public class GetActivePremiumPaymentsFailiureResponse {
    private final GetActivePremiumPaymentsResult reqR;
    private final String error;

    public GetActivePremiumPaymentsFailiureResponse(GetActivePremiumPaymentsResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
