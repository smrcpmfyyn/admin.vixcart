...
import com.vixcart.admin.intfc.validation.GetBrandsValidator;
 ...
 * @author Vineeth K
 */
public class GetBrandsConstraints implements GetBrandsValidator {

    private final GetBrands req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetBrandsConstraints(GetBrands req) throws Exception {
        this.req = req;
