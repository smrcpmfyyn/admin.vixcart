...
import com.vixcart.admin.intfc.validation.GetTaCsValidator;
 ...
 * @author Vineeth K
 */
public class GetTaCsConstraints implements GetTaCsValidator {

    private final GetTaCs req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetTaCsConstraints(GetTaCs req) throws Exception {
        this.req = req;
