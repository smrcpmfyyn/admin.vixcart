 ...
 * @author rifaie
 */
public class GetAllPremiumPaymentsValidation implements Validation{
    private final GetAllPremiumPayments req;
    private String paramValue = "";
    private String paramName = "";

    public GetAllPremiumPaymentsValidation(GetAllPremiumPayments req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        GetAllPremiumPaymentsConstraints reqC = new GetAllPremiumPaymentsConstraints(req);
        String valid = "";
