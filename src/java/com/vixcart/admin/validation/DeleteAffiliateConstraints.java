...
import com.vixcart.admin.intfc.validation.DeleteAffiliateValiadtor;
 ...
 * @author rifaie
 */
public class DeleteAffiliateConstraints implements DeleteAffiliateValiadtor{
    
    private final DeleteAffiliate req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public DeleteAffiliateConstraints(DeleteAffiliate req) throws Exception {
        this.req = req;
    ...
    public String validateAffiliate() throws Exception {
        ...
        if (validate(aff,regx)) {
            if (dbc.validateAffiliate(aff)) {
                valid = CorrectMsg.CORRECT_AFFILIATE;
            }else{
                valid = ErrMsg.ERR_AFFILIATE_NOT_EXISTS;
            }
        }
        return valid;
    }
