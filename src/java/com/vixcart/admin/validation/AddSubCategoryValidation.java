 ...
 * @author Vineeth K
 */
public class AddSubCategoryValidation implements Validation{
    private final AddSubCategory req;
    private String paramValue = "";
    private String paramName = "";

    public AddSubCategoryValidation(AddSubCategory req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        AddSubCategoryConstraints reqC = new AddSubCategoryConstraints(req);
        String valid = "";
        ...
        if (valid.startsWith(CorrectMsg.CORRECT_MESSAGE)) {
            ...
            if(valid1.startsWith(CorrectMsg.CORRECT_MESSAGE)){
                valid += "#"+reqC.validateSubCategory();
