...
import com.vixcart.admin.intfc.validation.GetBPaCsValidator;
 ...
 * @author Vineeth K
 */
public class GetBPaCsConstraints implements GetBPaCsValidator {

    private final GetBPaCs req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetBPaCsConstraints(GetBPaCs req) throws Exception {
        this.req = req;
