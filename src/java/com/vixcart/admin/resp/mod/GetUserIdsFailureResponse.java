 ...
 * @author rifaie
 */
public class GetUserIdsFailureResponse {
    private final GetUserIdsResult reqR;
    private final String error;

    public GetUserIdsFailureResponse(GetUserIdsResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
