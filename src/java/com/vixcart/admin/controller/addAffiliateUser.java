...
import com.vixcart.admin.processreq.ProcessAddAffiliateUser;
import com.vixcart.admin.req.mod.AddAffiliateUser;
import com.vixcart.admin.resp.mod.AddAffiliateUserFailureResponse;
...
import com.vixcart.admin.validation.AddAffiliateUserValidation;
...
public class addAffiliateUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            String affiliate = request.getParameter("aff");
