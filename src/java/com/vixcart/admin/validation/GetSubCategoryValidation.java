 ...
 * @author Vineeth K
 */
public class GetSubCategoryValidation implements Validation{
    private final GetSubCategory req;
    private String paramValue = "";
    private String paramName = "";

    public GetSubCategoryValidation(GetSubCategory req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        GetSubCategoryConstraints reqC = new GetSubCategoryConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_GET_SUB_CATEGORY;
        } else {
            paramValue += ErrMsg.ERR_GET_SUB_CATEGORY;
        }
    }
