 ...
 * @author Vineeth K
 */
public class GetSpecificationFailureResponse {
private final GetSpecificationResult req;
    private final String error;

    public GetSpecificationFailureResponse(GetSpecificationResult req, String error) {
        this.req = req;
        this.error = error;
    }
