 ...
 * @author Vineeth K
 */
public class AddSpecificationValidation implements Validation{
    private final AddSpecification req;
    private String paramValue = "";
    private String paramName = "";

    public AddSpecificationValidation(AddSpecification req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        AddSpecificationConstraints reqC = new AddSpecificationConstraints(req);
        String valid = "";
