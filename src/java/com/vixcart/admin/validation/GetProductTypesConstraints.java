...
import com.vixcart.admin.intfc.validation.GetProductTypesValidator;
 ...
 * @author Vineeth K
 */
public class GetProductTypesConstraints implements GetProductTypesValidator {

    private final GetProductTypes req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetProductTypesConstraints(GetProductTypes req) throws Exception {
        this.req = req;
