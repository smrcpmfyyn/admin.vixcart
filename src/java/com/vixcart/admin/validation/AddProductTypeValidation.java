 ...
 * @author Vineeth K
 */
public class AddProductTypeValidation implements Validation{
    private final AddProductType req;
    private String paramValue = "";
    private String paramName = "";

    public AddProductTypeValidation(AddProductType req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        AddProductTypeConstraints reqC = new AddProductTypeConstraints(req);
        String valid = "";
