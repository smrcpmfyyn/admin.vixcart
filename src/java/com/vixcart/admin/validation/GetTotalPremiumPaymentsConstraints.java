...
import com.vixcart.admin.intfc.validation.GetTotalPremiumPaymentsValiadtor;
 ...
 * @author rifaie
 */
public class GetTotalPremiumPaymentsConstraints implements GetTotalPremiumPaymentsValiadtor {

    private final GetTotalPremiumPayments req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetTotalPremiumPaymentsConstraints(GetTotalPremiumPayments req) throws Exception {
        this.req = req;
