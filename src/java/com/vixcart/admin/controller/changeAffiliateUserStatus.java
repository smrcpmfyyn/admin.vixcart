...
import com.vixcart.admin.processreq.ProcessChangeAffiliateUserStatus;
import com.vixcart.admin.req.mod.ChangeAffiliateUserStatus;
import com.vixcart.admin.resp.mod.ChangeAffiliateUserStatusFailureResponse;
...
import com.vixcart.admin.validation.ChangeAffiliateUserStatusValidation;
...
public class changeAffiliateUserStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Logger.getLogger(changeAffiliateUserStatus.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
