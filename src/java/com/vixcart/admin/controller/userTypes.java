...
import com.vixcart.admin.processreq.ProcessUserTypes;
 ...
 * @author rifaie
 */
public class userTypes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            UserActivities ua = new UserActivities(req.getAdmin_id(), req.getType(), "user_types", "management", "valid");
            if (validSubmission.startsWith(CorrectMsg.CORRECT_MESSAGE)) {
                ProcessUserTypes process = new ProcessUserTypes(req);
                UserTypesSuccessResponse SResp = process.processRequest();
...
//            ua.addActivity();
            ...
            Logger.getLogger(userTypes.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
