...
import com.vixcart.admin.processreq.ProcessAddPremiumPayment;
import com.vixcart.admin.req.mod.AddPremiumPayment;
import com.vixcart.admin.resp.mod.AddPremiumPaymentFailureResponse;
...
import com.vixcart.admin.validation.AddPremiumPaymentValidation;
 ...
 * @author rifaie
 */
public class addPremiumPayment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            AddPremiumPayment req = new AddPremiumPayment(at, company, referenceNo, amount);
            AddPremiumPaymentValidation reqV = new AddPremiumPaymentValidation(req);
            reqV.validation();
            AddPremiumPaymentResult reqR = JSONParser.parseJSONAddPP(reqV.toString());
            String validSubmission = reqR.getValidationResult();
            UserActivities ua = new UserActivities(req.getAdmin_id(), req.getUtype(), "add_premium_payment", "affiliate", "valid");
            ...
            Logger.getLogger(addPremiumPayment.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
