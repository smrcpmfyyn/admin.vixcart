...
import com.vixcart.admin.processreq.ProcessEmpReport;
import com.vixcart.admin.req.mod.EmpReport;
import com.vixcart.admin.resp.mod.EmpReportFailureResponse;
...
import com.vixcart.admin.validation.EmpReportValidation;
...
public class employeeReports extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            EmpReport req = new EmpReport(at);
            EmpReportValidation reqV = new EmpReportValidation(req);
            reqV.validation();
            EmpReportResult reqR = JSONParser.parseJSONEmpR(reqV.toString());
            String validSubmission = reqR.getValidationResult();
            UserActivities ua = new UserActivities(req.getAdmin_id(), req.getType(), "employee_reports", "management", "valid");
            if (validSubmission.equals(CorrectMsg.CORRECT_MESSAGE)) {
                ...
                EmpReportFailureResponse empFResp = new EmpReportFailureResponse(reqR, validSubmission);
