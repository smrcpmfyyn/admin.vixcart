 ...
 * @author Vineeth K
 */
public class GetSuperCategoriesValidation implements Validation{

    private final GetSuperCategories req;
    private String paramName = "";
    private String paramValue = "";

    public GetSuperCategoriesValidation(GetSuperCategories gsc) {
        this.req = gsc;
    }
    ...
    public void validation() throws Exception {
        GetSuperCategoriesConstraints reqC = new GetSuperCategoriesConstraints(req);
        String valid = "";
