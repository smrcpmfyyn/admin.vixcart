 ...
 * @author Vineeth K
 */
public class SearchProductTypeValidation implements Validation{
    private final SearchProductType req;
    private String paramValue = "";
    private String paramName = "";

    public SearchProductTypeValidation(SearchProductType req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        SearchProductTypeConstraints reqC = new SearchProductTypeConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_SEARCH_PTYPE;
        } else {
            paramValue += ErrMsg.ERR_SEARCH_PTYPE;
        }
    }
