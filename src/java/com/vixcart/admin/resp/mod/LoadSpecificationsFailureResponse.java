 ...
 * @author Vineeth K
 */
public class LoadSpecificationsFailureResponse {

    private final LoadSpecificationsResult req;
    private final String error;

    public LoadSpecificationsFailureResponse(LoadSpecificationsResult req, String error) {
        this.req = req;
        this.error = error;
    }
