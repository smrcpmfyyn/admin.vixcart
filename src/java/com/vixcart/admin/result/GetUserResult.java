...
public class GetUserResult implements Result{
    ...
    public String getGetUserValidation() {
        return getUserValidation;
    }

    public void setGetUserValidation(String getUserValidation) {
        this.getUserValidation = getUserValidation;
    }
    ...
    public boolean isRequestValid() {
        boolean flag = false;
        if (getUserValidation.startsWith(CorrectMsg.CORRECT_MESSAGE)) {
            flag = true;
        }
        return flag;
    }
    ...
    public String getAllErrors() {
        ...
        if (at.startsWith(ErrMsg.ERR_MESSAGE)) {
            ...
            if (slno.startsWith(ErrMsg.ERR_MESSAGE)) {
                error += "slno#";
            }
        }
