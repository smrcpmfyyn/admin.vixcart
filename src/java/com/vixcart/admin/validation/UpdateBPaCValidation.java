 ...
 * @author Vineeth K
 */
public class UpdateBPaCValidation implements Validation{
    private final UpdateBPaC req;
    private String paramValue = "";
    private String paramName = "";

    public UpdateBPaCValidation(UpdateBPaC req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        UpdateBPaCConstraints reqC = new UpdateBPaCConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_UPDATE_BPAC;
        } else {
            paramValue += ErrMsg.ERR_UPDATE_BPAC;
        }
    }
