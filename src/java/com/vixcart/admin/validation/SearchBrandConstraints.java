...
import com.vixcart.admin.intfc.validation.SearchBrandValidator;
 ...
 * @author Vineeth K
 */
public class SearchBrandConstraints implements SearchBrandValidator {

    private final SearchBrand req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public SearchBrandConstraints(SearchBrand req) throws Exception {
        this.req = req;
