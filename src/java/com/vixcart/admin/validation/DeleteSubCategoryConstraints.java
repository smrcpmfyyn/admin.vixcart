...
import com.vixcart.admin.intfc.validation.DeleteSubCategoryValidator;
 ...
 * @author Vineeth K
 */
public class DeleteSubCategoryConstraints implements DeleteSubCategoryValidator{

    private final DeleteSubCategory req;
    private final MongoConnect mdbc;
    private final DBConnect dbc;

    public DeleteSubCategoryConstraints(DeleteSubCategory req) throws Exception {
        this.req = req;
