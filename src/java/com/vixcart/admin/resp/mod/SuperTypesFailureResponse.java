 ...
 * @author rifaie
 */
public class SuperTypesFailureResponse {
    private final SuperUserTypesResult typeR;
    private final String error;

    public SuperTypesFailureResponse(SuperUserTypesResult typeR, String error) {
        this.typeR = typeR;
        this.error = error;
    }
