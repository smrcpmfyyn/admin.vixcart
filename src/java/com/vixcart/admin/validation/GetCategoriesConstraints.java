...
import com.vixcart.admin.intfc.validation.GetCategoriesValidator;
 ...
 * @author Vineeth K
 */
public class GetCategoriesConstraints implements GetCategoriesValidator {

    private final GetCategories req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetCategoriesConstraints(GetCategories gsc) throws Exception {
        this.req = gsc;
