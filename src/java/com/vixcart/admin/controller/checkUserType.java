...
import com.vixcart.admin.processreq.ProcessCheckUserType;
...
public class checkUserType extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            UserActivities ua = new UserActivities(req.getAdmin_id(), req.getUtype(), "check_user_type", "management", "valid");
