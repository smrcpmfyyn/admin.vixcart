 ...
 * @author Vineeth K
 */
public class DeleteBPaCValidation implements Validation{
    private final DeleteBPaC req;
    private String paramValue = "";
    private String paramName = "";

    public DeleteBPaCValidation(DeleteBPaC req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        DeleteBPaCConstraints reqC = new DeleteBPaCConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_DELETE_BPAC;
        } else {
            paramValue += ErrMsg.ERR_DELETE_BPAC;
        }
    }
