 ...
 * @author rifaie
 */
public class EmpReportFailureResponse {
    private final EmpReportResult empRR;
    private final String error;

    public EmpReportFailureResponse(EmpReportResult empRR, String error) {
        this.empRR = empRR;
        this.error = error;
    }
    ...
    public String toString() {
        ...
        for (int i = 1; i < errors.length; i++) {
            ...
            switch (parameter) {
                case "at":
                    String at = empRR.getAt();
                    resp = at.substring(at.lastIndexOf(" ") + 1);
                    json += "\"" + parameter + "\"" + ":" + "\"" + resp + "\" ,";
                    break;
                case "admintype":
                    String admType = empRR.getAdmintype();
