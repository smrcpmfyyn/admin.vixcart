 ...
 * @author rifaie
 */
public class GetTotalPremiumPaymentsFailiureResponse {
    private final GetTotalPremiumPaymentsResult reqR;
    private final String error;

    public GetTotalPremiumPaymentsFailiureResponse(GetTotalPremiumPaymentsResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
