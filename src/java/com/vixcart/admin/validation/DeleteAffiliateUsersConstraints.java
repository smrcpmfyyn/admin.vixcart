...
import com.vixcart.admin.intfc.validation.DeleteAffiliateUsersValiadtor;
...
public class DeleteAffiliateUsersConstraints implements DeleteAffiliateUsersValiadtor {
    ...
    public DeleteAffiliateUsersConstraints(DeleteAffiliateUsers req) throws Exception {
        this.req = req;
