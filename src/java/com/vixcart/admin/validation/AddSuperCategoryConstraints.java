...
// <editor-fold defreqltstate="collapsed" desc="packages">
import com.vixcart.admin.db.DB;
import com.vixcart.admin.db.DBConnect;
import com.vixcart.admin.db.MongoConnect;
import com.vixcart.admin.intfc.validation.AddSuperCategoryValidator;
 ...
 * @reqthor Vineeth K
 */
public class AddSuperCategoryConstraints implements AddSuperCategoryValidator{

    private final AddSuperCategory req;
    private final MongoConnect mdbc;
    private final DBConnect dbc;

    public AddSuperCategoryConstraints(AddSuperCategory req) throws Exception {
        this.req = req;
...
//        System.out.println("name = " + name);
        if (validate(name, regX)) {
            if (dbc.checkSuperCategory(name)==0) {
                ...
                valid = ErrMsg.ERR_SUPER_CATEGORY_EXISTS;
            }
        }
        return valid;
    }
