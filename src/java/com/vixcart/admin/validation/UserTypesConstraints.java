...
import com.vixcart.admin.intfc.validation.UserTypesValidator;

/**
 * @company techvay
 * @author rifaie
 */
public class UserTypesConstraints implements UserTypesValidator{
    private final UserTypes type;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public UserTypesConstraints(UserTypes type) throws Exception {
        this.type = type;
