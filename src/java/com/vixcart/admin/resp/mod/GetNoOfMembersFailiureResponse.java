 ...
 * @author rifaie
 */
public class GetNoOfMembersFailiureResponse {
    private final GetNoOfMembersResult reqR;
    private final String error;

    public GetNoOfMembersFailiureResponse(GetNoOfMembersResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
