 ...
 * @author rifaie
 */
public class GetAffiliateRequestsFailureResponse {

    private final GetAffiliateRequestsResult reqR;
    private final String error;

    public GetAffiliateRequestsFailureResponse(GetAffiliateRequestsResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
        ...
        for (int i = 1; i < errors.length; i++) {
            ...
            switch (parameter) {
                ...
                case "offset":
                    ...
                    break;
                case "status":
                    String st = reqR.getStatus();
                    resp = st.substring(st.lastIndexOf(" ") + 1);
                    json += "\"" + parameter + "\"" + ":" + "\"" + resp + "\" ,";
                    break;
            }
        }
