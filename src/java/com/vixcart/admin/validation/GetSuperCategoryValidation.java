 ...
 * @author Vineeth K
 */
public class GetSuperCategoryValidation implements Validation{
    private final GetSuperCategory req;
    private String paramValue = "";
    private String paramName = "";

    public GetSuperCategoryValidation(GetSuperCategory req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        GetSuperCategoryConstraints reqC = new GetSuperCategoryConstraints(req);
        String valid = "";
