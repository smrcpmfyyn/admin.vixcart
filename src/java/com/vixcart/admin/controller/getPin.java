...
import com.vixcart.admin.processreq.ProcessGetPin;
import com.vixcart.admin.req.mod.GetPin;
import com.vixcart.admin.resp.mod.GetPinFailureResponse;
...
import com.vixcart.admin.validation.GetPinValidation;
...
public class getPin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            GetPin req = new GetPin(at);
            GetPinValidation reqV = new GetPinValidation(req);
            reqV.validation();
            GetPinResult reqR = JSONParser.parseJSONGP(reqV.toString());
            String validSubmission = reqR.getValidationResult();
            UserActivities ua = new UserActivities(req.getAdmin_id(), req.getType(), "get_pin", "management", "valid");
