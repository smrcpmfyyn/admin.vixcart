 ...
 * @author Vineeth K
 */
public class AddBrandValidation implements Validation{
    private final AddBrand req;
    private String paramValue = "";
    private String paramName = "";

    public AddBrandValidation(AddBrand req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        AddBrandConstraints reqC = new AddBrandConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_ADD_BRAND;
        } else {
            paramValue += ErrMsg.ERR_ADD_BRAND;
        }
    }
