 ...
 * @author rifaie
 */
public class GetAffiliateRequestFailureResponse {
    private final GetAffiliateRequestResult reqR;
    private final String error;

    public GetAffiliateRequestFailureResponse(GetAffiliateRequestResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
        ...
        for (int i = 1; i < errors.length; i++) {
            ...
            switch (parameter) {
                ...
                case "admintype":
                    ...
                    break;
                case "rid":
                    String rid = reqR.getRid();
                    resp = rid.substring(rid.lastIndexOf(" ") + 1);
                    json += "\"" + parameter + "\"" + ":" + "\"" + resp + "\" ,";
                    break;
            }
        }
