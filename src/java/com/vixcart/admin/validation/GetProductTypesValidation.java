 ...
 * @author Vineeth K
 */
public class GetProductTypesValidation implements Validation{
    private final GetProductTypes req;
    private String paramValue = "";
    private String paramName = "";

    public GetProductTypesValidation(GetProductTypes req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        GetProductTypesConstraints reqC = new GetProductTypesConstraints(req);
        String valid = "";
