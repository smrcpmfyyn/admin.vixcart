...
import com.vixcart.admin.intfc.validation.DeleteBrandValidator;
 ...
 * @author Vineeth K
 */
public class DeleteBrandConstraints implements DeleteBrandValidator {

    private final DeleteBrand req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public DeleteBrandConstraints(DeleteBrand req) throws Exception {
        this.req = req;
