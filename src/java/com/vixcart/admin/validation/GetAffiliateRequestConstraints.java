...
import com.vixcart.admin.intfc.validation.GetAffiliateRequestValidator;
 ...
 * @author rifaie
 */
public class GetAffiliateRequestConstraints implements GetAffiliateRequestValidator {
    private final GetAffiliateRequest req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetAffiliateRequestConstraints(GetAffiliateRequest req) throws Exception {
        this.req = req;
