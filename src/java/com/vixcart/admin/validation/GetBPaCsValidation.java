 ...
 * @author Vineeth K
 */
public class GetBPaCsValidation implements Validation{
    private final GetBPaCs req;
    private String paramValue = "";
    private String paramName = "";

    public GetBPaCsValidation(GetBPaCs req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        GetBPaCsConstraints reqC = new GetBPaCsConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_GET_BPACS;
        } else {
            paramValue += ErrMsg.ERR_GET_BPACS;
        }
    }
