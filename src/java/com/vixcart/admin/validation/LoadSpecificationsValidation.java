 ...
 * @author Vineeth K
 */
public class LoadSpecificationsValidation implements Validation{
    private final LoadSpecifications req;
    private String paramValue = "";
    private String paramName = "";

    public LoadSpecificationsValidation(LoadSpecifications req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        LoadSpecificationsConstraints reqC = new LoadSpecificationsConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_LOAD_SPEC;
        } else {
            paramValue += ErrMsg.ERR_LOAD_SPEC;
        }
    }
