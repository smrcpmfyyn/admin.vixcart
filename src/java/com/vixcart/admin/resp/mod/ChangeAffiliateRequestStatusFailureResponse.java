 ...
 * @author rifaie
 */
public class ChangeAffiliateRequestStatusFailureResponse {
    private final ChangeAffiliateRequestStatusResult reqR;
    private final String error;

    public ChangeAffiliateRequestStatusFailureResponse(ChangeAffiliateRequestStatusResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
