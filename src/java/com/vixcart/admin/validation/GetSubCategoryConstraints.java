...
import com.vixcart.admin.intfc.validation.GetSubCategoryValidator;
 ...
 * @author Vineeth K
 */
public class GetSubCategoryConstraints implements GetSubCategoryValidator {

    private final GetSubCategory req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetSubCategoryConstraints(GetSubCategory req) throws Exception {
        this.req = req;
