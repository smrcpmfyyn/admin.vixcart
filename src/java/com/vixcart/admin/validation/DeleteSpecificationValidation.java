 ...
 * @author Vineeth K
 */
public class DeleteSpecificationValidation implements Validation{
    private final DeleteSpecification req;
    private String paramValue = "";
    private String paramName = "";

    public DeleteSpecificationValidation(DeleteSpecification req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        DeleteSpecificationConstraints reqC = new DeleteSpecificationConstraints(req);
        String valid = "";
