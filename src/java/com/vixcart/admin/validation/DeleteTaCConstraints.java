...
import com.vixcart.admin.intfc.validation.DeleteTaCValidator;
 ...
 * @author Vineeth K
 */
public class DeleteTaCConstraints implements DeleteTaCValidator {

    private final DeleteTaC req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public DeleteTaCConstraints(DeleteTaC req) throws Exception {
        this.req = req;
