 ...
 * @author rifaie
 */
public class GetMembersValidation implements Validation{
    
    private final GetMembers req;
    private String paramValue = "";
    private String paramName = "";

    public GetMembersValidation(GetMembers gu) {
        this.req = gu;
    }

    @Override
    public void validation() throws Exception {
        GetMembersConstraints reqC = new GetMembersConstraints(req);
        String valid = "";
        ...
        if (count == 0) {
            paramValue += CorrectMsg.CORRECT_GET_MEMBERS;
        } else {
            paramValue += ErrMsg.ERR_GET_MEMBERS;
        }
    }
