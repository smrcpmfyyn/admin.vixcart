 ...
 * @author Vineeth K
 */
public class UpdateSuperCategoryFailureResponse {

    private final UpdateSuperCategoryResult req;
    private final String error;

    public UpdateSuperCategoryFailureResponse(UpdateSuperCategoryResult addTypR, String error) {
        this.req = addTypR;
        this.error = error;
    }
