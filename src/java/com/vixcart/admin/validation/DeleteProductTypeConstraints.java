...
import com.vixcart.admin.intfc.validation.DeleteProductTypeValidator;
 ...
 * @author Vineeth K
 */
public class DeleteProductTypeConstraints implements DeleteProductTypeValidator{

    private final DeleteProductType req;
    private final MongoConnect mdbc;
    private final DBConnect dbc;

    public DeleteProductTypeConstraints(DeleteProductType req) throws Exception {
        this.req = req;
...
//        System.out.println("types = " + types);
    ...
    @Override
    public String validateProductType() throws Exception {
