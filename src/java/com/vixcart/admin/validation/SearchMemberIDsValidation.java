 ...
 * @author rifaie
 */
public class SearchMemberIDsValidation implements Validation{
    private final SearchMemberIDs req;
    private String paramValue = "";
    private String paramName = "";

    public SearchMemberIDsValidation(SearchMemberIDs req) {
        this.req = req;
    }

    @Override
    public void validation() throws Exception {
        SearchMemberIDsConstraints reqC = new SearchMemberIDsConstraints(req);
        String valid = "";
