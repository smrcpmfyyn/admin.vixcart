...
public class UsersResult implements Result{
    ...
    private String usersValidation;
    ...
    public String getUsersValidation() {
        return usersValidation;
    }

    public void setUsersValidation(String usersValidation) {
    ...
    public boolean isRequestValid() {
        boolean flag = false;
        if (usersValidation.startsWith(CorrectMsg.CORRECT_MESSAGE)) {
            flag = true;
        }
        return flag;
    }
