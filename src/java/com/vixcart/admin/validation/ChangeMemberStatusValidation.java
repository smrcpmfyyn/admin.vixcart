 ...
 * @author rifaie
 */
public class ChangeMemberStatusValidation implements Validation{
    
    private final ChangeMemberStatus req;
    private String paramValue = "";
    private String paramName = "";

    public ChangeMemberStatusValidation(ChangeMemberStatus gu) {
        this.req = gu;
    }

    @Override
    public void validation() throws Exception {
        ChangeMemberStatusConstraints reqC = new ChangeMemberStatusConstraints(req);
        String valid = "";
