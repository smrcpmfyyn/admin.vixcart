...
import com.vixcart.admin.intfc.validation.GetMembersValidator;
 ...
 * @author rifaie
 */
public class GetMembersConstraints implements GetMembersValidator {

    private final GetMembers req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetMembersConstraints(GetMembers req) throws Exception {
        this.req = req;
    ...
    public String validateQuery() throws Exception {
        ...
        if (validate(query, regX)) {
            String queryType = mdbc.getSearchMemeberQueryType(query);
