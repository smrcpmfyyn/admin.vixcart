 ...
 * @author Vineeth K
 */
public class GetProductTypeFailureResponse {
private final GetProductTypeResult req;
    private final String error;

    public GetProductTypeFailureResponse(GetProductTypeResult req, String error) {
        this.req = req;
        this.error = error;
    }
