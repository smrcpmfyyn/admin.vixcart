...
import com.vixcart.admin.intfc.validation.DeleteSpecificationValidator;
 ...
 * @author Vineeth K
 */
public class DeleteSpecificationConstraints implements DeleteSpecificationValidator {

    private final DeleteSpecification req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public DeleteSpecificationConstraints(DeleteSpecification req) throws Exception {
        this.req = req;
