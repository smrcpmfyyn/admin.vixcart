...
public final class AdminEmail {
    ...
    public static void sendResetPassword(String to, String passwordToken, String name) throws Exception{
        ...
        message.setText("Hello " + name + ",\n"
                ...
                + "--\n"
                + "Please click on the link below to reset your password:\n\n" + URLs.getPASSWORD_GENERATION() + URLEncoder.encode(passwordToken,"UTF-8"));
