 ...
 * @author rifaie
 */
public class DeleteAffiliateFailiureResponse {
    private final DeleteAffiliateResult reqR;
    private final String error;

    public DeleteAffiliateFailiureResponse(DeleteAffiliateResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
        ...
        for (int i = 1; i < errors.length; i++) {
            ...
            switch (parameter) {
                ...
                case "admintype":
                    ...
                    break;
                case "affiliate":
                    String offset=  reqR.getAffiliate();
