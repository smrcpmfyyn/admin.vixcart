 ...
 * @author rifaie
 */
public class DeleteAffiliateUsersFailureResponse {
    private final DeleteAffiliateUsersResult reqR;
    private final String error;

    public DeleteAffiliateUsersFailureResponse(DeleteAffiliateUsersResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
        ...
        for (int i = 1; i < errors.length; i++) {
            ...
            switch (parameter) {
                ...
                case "admintype":
                    ...
                    break;
                case "auid":
                    String auid =  reqR.getAuid();
                    resp = auid.substring(auid.lastIndexOf(" ") + 1);
                    json += "\"" + parameter + "\"" + ":" + "\"" + resp + "\" ,";
                    break;
            }
        }
