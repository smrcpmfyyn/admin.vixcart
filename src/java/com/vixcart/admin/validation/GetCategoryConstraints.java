...
import com.vixcart.admin.intfc.validation.GetCategoryValidator;
 ...
 * @author Vineeth K
 */
public class GetCategoryConstraints implements GetCategoryValidator {

    private final GetCategory req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetCategoryConstraints(GetCategory req) throws Exception {
        this.req = req;
