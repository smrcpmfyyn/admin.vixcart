...
import com.vixcart.admin.processreq.ProcessGetAllAffiliates;
import com.vixcart.admin.req.mod.GetAllAffiliates;
import com.vixcart.admin.resp.mod.GetAllAffiliatesFailureResponse;
...
import com.vixcart.admin.validation.GetAllAffiliatesValidation;
 ...
 * @author rifaie
 */
public class getAllAffiliates extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            GetAllAffiliates req = new GetAllAffiliates(at, pageNo, maxEntries);
            GetAllAffiliatesValidation reqV = new GetAllAffiliatesValidation(req);
            reqV.validation();
            GetAllAffiliatesResult reqR = JSONParser.parseJSONGAA(reqV.toString());
            ...
            if (validSubmission.equals(CorrectMsg.CORRECT_MESSAGE)) {
                ProcessGetAllAffiliates processor = new ProcessGetAllAffiliates(req);
                GetAllAffiliatesSuccessResponse SResp = processor.processRequest();
                ...
                GetAllAffiliatesFailureResponse FResp = new GetAllAffiliatesFailureResponse(reqR, validSubmission);
                out.println(FResp);
            } else {
                //exception Response
            }
